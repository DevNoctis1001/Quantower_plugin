...
namespace GDIBasedPlugin
{
    public class GDIRenderer : Renderer
    {
           ...
           : base(native)
        {
            ...
            this.bufferedGraphic = new BufferedGraphic(this.Draw, this.Refresh, native.DisposeImage, native.IsDisplayed,BufferedGraphicRequiredThreadType.ChartsThread);
        }
        ...
        public override nint Render()
        {
            return this.bufferedGraphic.CurrentImage;
        }
